...
const Publish = () => {
  return (
    <div className="publish--container my-6 flex flex-col justify-between lg:flex-row">
      ...
      <div className="publish--text basis-full lg:basis-1/2 font-poppins flex py-4 px-6 gap-8 lg:gap-0  flex-col text-center items-center justify-start lg:justify-around">
        <img
